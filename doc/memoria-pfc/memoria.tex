...
% Copyright (C) 2009-2011 Pablo Recio Quijano, David Saltares Márquez
...
\input{texto/introduccion.tex}

\chapter{Calendario}
\input{texto/calendario.tex}

\chapter{Desarrollo de IberOgre}
\input{texto/desarrollo-iberogre.tex}

\chapter{Desarrollo de Sion Tower}
\input{texto/desarrollo-siontower.tex}

\chapter{Conclusiones}
\input{texto/conclusiones.tex}
